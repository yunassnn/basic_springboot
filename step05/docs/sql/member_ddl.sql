...
-- 다중조건 테스트를 위한 레코드 초기화 추가 : 다중조건을 참고해서 데이터정보를 설정 추가
insert into member(member_id, member_pw, name, mobile, email, entry_date, grade, mileage)
values('test01', 'password01', 'test01', '010-1234-1111', 'test01@work.com	', '2019.04.05', 'G', 4500);

insert into member
values('test02', 'password02', 'test02', '010-1234-1112', 'test02@work.com', '2019.05.06', 'G', 5000, null);

insert into member
values('test03', 'password03', 'test03', '010-1234-1113', 'test03@work.com', '2019.11.07', 'G', 3000, null);

insert into member
values('test04', 'password04', 'test04', '010-1234-1114', 'test04@work.com', '2020.12.08', 'S', null, '송중기');

insert into member
values('test05', 'password05', 'test05', '010-1234-1115', 'test05@work.com', '2021.05.09', 'S', null, '이재현');
